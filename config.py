...
UMBRALES = {
    "nivel":       {"min": 10.0,  "max": 100.0, "unidad": "m"},
    "caudal":      {"min": 5.0,   "max": 150.0, "unidad": "m3/s"},
    "rpm":         {"min": 100.0, "max": 1800.0, "unidad": "RPM"},
    "temperatura": {"min": 10.0,  "max": 90.0,  "unidad": "C"},
    "voltaje":     {"min": 180.0, "max": 250.0, "unidad": "V"},
}
